...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use our AI thumbnail generator?" text3="Stunning thumbnails that will get you more views and subscribers." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Boost your views with AI optimized thumbnails </h3>
                        <p className="text-slate-300 mt-2">Thumbly makes creating thumbnails easy and fast.</p>
